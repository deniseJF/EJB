...
public class ControladorIT {
	...
	public void inicializar() throws Exception {
		...
		controladora = (ControladorSistema) context.lookup("java:global/fourpizza-business/ControladorSistema!labs.fourpizza.dominio.controlador.ControladorSistema");
	}
