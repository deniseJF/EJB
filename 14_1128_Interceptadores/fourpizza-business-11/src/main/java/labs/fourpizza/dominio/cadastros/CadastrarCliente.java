...
public class CadastrarCliente{// implements CadastroClienteLocal{
	...
	@AroundInvoke
	public Object auditoriaSingleto(InvocationContext ic) throws Exception{
		System.out.println("Entrou na auditoria Stateful");
		Object obj = ic.proceed();
		System.out.println("Saiu da auditoria Stateful");
		return obj;
	}
